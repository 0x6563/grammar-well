(function () {
    ...
    var grammar = {
        ...
        rules: [
            ...
            { "name": "completeexpression", "symbols": ["expr", "_", "js2"], "postprocess": function (d) { return { tokens: d[0], transform: d[2] }; } },
            ...
            { "name": "expr_member", "symbols": ["string", "expr_member$ebnf$1"], "postprocess": function (d) { if (d[1]) {
            ...
            { "name": "js2", "symbols": [(lexer.has("js2") ? { type: "js2" } : js2)], "postprocess": getValue },
