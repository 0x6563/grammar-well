...
function Grammar() {
    ...
    const lexer = {
        ...
        feed(input, state) {
            return moostates.reset(input, state);
        },
        state() {
    ...
    return {
        ...
        rules: [
            ...
            { "name": "completeexpression", "symbols": ["expr", "_", "js"], "postprocess": function ({ data }) { return { tokens: data[0], postprocess: data[2] }; } },
            ...
            { "name": "expr_member", "symbols": ["string", "expr_member$ebnf$1"], "postprocess": function ({ data }) { return data[1] ? insensitive(data[0]) : data[0]; } },
