    ...
    return {
        grammar: {
            ...
            rules: {
                ...
                int$RPT01x1$SUBx1: [
                    { name: "int$RPT01x1$SUBx1", symbols: [ {"literal":"-","insensitive":false} ] },
                    { name: "int$RPT01x1$SUBx1", symbols: [ {"literal":"+","insensitive":false} ] }
                ],
                int$RPT01x1: [
                ...
                unsigned_decimal$RPT01x1$SUBx1: [
                    { name: "unsigned_decimal$RPT01x1$SUBx1", symbols: [ {"literal":".","insensitive":false}, "unsigned_decimal$RPT01x1$SUBx1$RPT1Nx1" ] }
                ],
                ...
                decimal$RPT01x1: [
                    { name: "decimal$RPT01x1", symbols: [ {"literal":"-","insensitive":false} ], postprocess: ({data}) => data[0] },
                ...
                decimal$RPT01x2$SUBx1: [
                    { name: "decimal$RPT01x2$SUBx1", symbols: [ {"literal":".","insensitive":false}, "decimal$RPT01x2$SUBx1$RPT1Nx1" ] }
                ],
                decimal$RPT01x2: [
                ...
                percentage: [
                    { name: "percentage", symbols: [ "decimal", {"literal":"%","insensitive":false} ], postprocess: ({data}) => { return data[0]/100; } }
                ],
                jsonfloat$RPT01x1: [
                    { name: "jsonfloat$RPT01x1", symbols: [ {"literal":"-","insensitive":false} ], postprocess: ({data}) => data[0] },
                ...
                jsonfloat$RPT01x2$SUBx1: [
                    { name: "jsonfloat$RPT01x2$SUBx1", symbols: [ {"literal":".","insensitive":false}, "jsonfloat$RPT01x2$SUBx1$RPT1Nx1" ] }
                ],
                jsonfloat$RPT01x2: [
